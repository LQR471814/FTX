...
class MessageList extends React.Component {
    ...
    focusReply(focus) {
        if (focus > 0) {
            this.collapse(1)
            document.getElementById(this.state.inputFieldID).focus()
        } else {
            this.collapse(-1)
            document.getElementById(this.state.inputFieldID).blur()
        }
    }
                ...
                <div className="MessageGroupContainer" id={this.state.groupContainerID} onTransitionEnd={this.onCollapseFinish}>
                    ...
                    <div className="Message">
                        ...
                        <div style={{margin: "10px 5px 5px 5px", display: "flex", overflow: "hidden"}}>
                            <input className="InputField" id={this.state.msgInFieldID} placeholder="Message" onChange={this.onChange} onKeyDown={this.onKeyDown} />
